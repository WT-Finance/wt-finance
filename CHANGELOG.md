...
PATCH: **Refino visual do e-mail de notificação de Solicitações** (introduzido na v4.25.0). Migration aditiva (0158, `CREATE OR REPLACE`). Refina ADR-0128 — sem ADR novo.
