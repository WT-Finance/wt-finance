...
export const CHANGELOG_DIRETORIA: ChangelogEntrada[] = [
  {
    versao: '5.11.0',
    data: '2026-09-15T12:17', // autoria real (commit ddf3692); reconciliar ao merge no /pos-merge
    itens: [
      {
        tipo: 'novidade',
        texto:
  ...
  {
    versao: '5.10.3',
    data: '2026-09-15T10:03', // merge real do PR #271 (2026-09-15T13:03:34Z → -03)
    itens: [
      {
        tipo: 'melhoria',
        texto:
    ...
    itens: [
      {
        tipo: 'melhoria',
        texto:
          'Atualização de segurança do envio de e-mail da plataforma. Os e-mails automáticos ' +
          '(solicitações, acessos e faturas) continuam exatamente iguais — mesmo conteúdo, ' +
          'mesmo layout, mesma identidade. É manutenção preventiva.',
      },
    ],
  },
  {
    versao: '5.10.1',
    data: '2026-09-14T08:38', // merge real do PR #267 (2026-09-14T11:38:27Z → -03)
    itens: [
      {
        tipo: 'melhoria',
        texto:
          'Atualização de segurança do ambiente interno de testes — as ferramentas que conferem ' +
          'a plataforma antes de cada publicação. Nada muda para quem usa o sistema: as telas, ' +
          'os números e os relatórios seguem idênticos. É manutenção preventiva.',
      },
    ],
  },
  {
    versao: '5.10.0',
    data: '2026-09-13T21:13', // merge real do PR #265 (2026-09-14T00:13:58Z → -03)
    itens: [
      {
        tipo: 'melhoria',
        texto:
          'Arrumação interna da plataforma: organização de código, documentação e proteções de ' +
          'manutenção. Nada muda para quem usa o sistema — as telas, os números e os relatórios ' +
  ...
  {
    versao: '5.9.7',
    data: '2026-09-10T14:44', // horário de autoria; reconciliar ao merge real no /pos-merge
    itens: [
      {
        tipo: 'melhoria',
        texto:
          'Atualização de segurança dos componentes internos da plataforma. Nenhuma tela, número ou ' +
          'funcionalidade muda.',
      },
    ],
  },
  {
    versao: '5.9.6',
    data: '2026-09-10T11:45', // horário REAL do merge (885da65, PR #261, 10/09 11h45 −03) — reconciliado no /pos-merge
    itens: [
      {
        tipo: 'melhoria',
        texto:
