      ...
      <Section id="componentes" title="10. Componentes Compartilhados">
        <div className="space-y-2">
          {[
            ...
            { name: 'GatilhoAjuda',          path: 'src/components/ui/gatilho-ajuda.tsx',               desc: 'Afordância "?" de ajuda acessível: <button> (nunca <span>) dentro de Tooltip, aria-label "rótulo: texto"; props ancoraDireita/pararPropagacao/classNameBalao — v5.9.4' },
