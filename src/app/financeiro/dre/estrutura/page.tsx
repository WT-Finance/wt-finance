  ...
  return (
    <div className="relative">
      ...
      <div className="mb-6">
        ...
        <h1 className="pr-40 text-xl font-semibold text-text-primary">Estrutura do Demonstrativo de Resultado por Fluxo de Caixa</h1>
        <p className="mt-0.5 text-sm text-text-subtle">Reordene categorias e blocos do demonstrativo por fluxo de caixa</p>
      </div>
