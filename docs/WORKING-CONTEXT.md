...
🔴 **Pendente (Yan), em produção:** um desfazer real pela UI de cada editor (caixa, competência e Gerencial;
lote de 2–3 linhas) para provar que o caminho normal não regrediu. Fora do escopo,
