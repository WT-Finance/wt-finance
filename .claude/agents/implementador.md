...
- **Advisor:** cada consulta feita — momento (1, 2 ou 3), a pergunta em uma linha e se mudou
  o rumo (o quê). Nenhuma consulta → diga "nenhuma". É o dado que avalia o piloto.
