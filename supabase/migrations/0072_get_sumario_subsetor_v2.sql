-- ---------------------------------------------------------------------------
-- 0072 — feat: get_sumario_subsetor v2 — agrupar por subsetor_detalhado
--
-- ADR-0069: CONVIDADOS agora decomposto em Hospedagens e Extras.
-- A RPC passa a retornar 'subsetor_detalhado' no lugar de 'subsetor'
-- para que o componente exiba as 2 linhas de CONVIDADOS separadas.
-- ---------------------------------------------------------------------------
