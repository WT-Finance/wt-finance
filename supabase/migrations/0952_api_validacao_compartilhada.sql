-- ---------------------------------------------------------------------------
-- 0952 — feat(v5.4.0/M3a): validação COMPARTILHADA de Solicitações (extraída
...
--
-- NUMERAÇÃO: faixa PROVISÓRIA 0950+ (a versão em desenvolvimento é anterior à
-- v5.3.0 na numeração real de `supabase/migrations/`; o orquestrador RENUMERA
-- este arquivo para o próximo número real no merge — não decidir isso aqui).
--
...
--     é da 0951, sem dado ainda inserido).
...
BEGIN
  ...
  -- integração é o ack síncrono + callbacks (ADR-0953).
