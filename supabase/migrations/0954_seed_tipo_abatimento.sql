-- ---------------------------------------------------------------------------
-- 0954 — feat(v5.4.0/M5): seed do tipo "Abatimento de créditos" (primeiro tipo
...
--
-- NUMERAÇÃO: faixa PROVISÓRIA 0950+ (renumeração no checklist de merge).
--
-- DECLARAÇÃO PRÉVIA (regime aditivo / autônomo):
--   • O QUE FAZ: INSERT de 1 tipo de solicitação novo + seus 9 campos (dados
