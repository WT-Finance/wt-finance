-- ---------------------------------------------------------------------------
-- 0951 — feat(v5.4.0/M2): Chaves de API para a API externa de Solicitações
--
-- NUMERAÇÃO PROVISÓRIA (faixa 0950+): o orquestrador renumera este arquivo para
-- a numeração real (verificar supabase/migrations/ no momento da integração)
-- antes de aplicar. Não aplicado por este subagente (editor puro).
--
